...
grep -q 'AxiomUIOverlay' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'view.hidden = YES' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'enableTouchOverlayEvent:YES' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q '\[self.view endEditing:YES\]' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
...
test "$(grep -c 'loadTemplateFromURL:@\"axiom.app.lynx\"' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m")" -eq 1
...
grep -q 'UIAccessibilityIsReduceMotionEnabled' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'UIAccessibilityReduceMotionStatusDidChangeNotification' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
...
grep -q 'shouldDispatchLifecycleEvent' "$host_dir/scripts/build-ios.sh"
...
grep -q 'registerUI:LynxUISVG.class withName:@"svg"' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'registerUI:LynxUIRefresh.class withName:@"refresh"' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'registerUI:LynxUIViewPager.class withName:@"viewpager"' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
grep -q 'registerUI:LynxUIScrollCoordinator.class withName:@"scroll-coordinator"' "$host_dir/ios/AxiomUIHost/AxiomHostViewController.m"
...
grep -q 'CARGO_TARGET_DIR="$web_target_dir"' "$host_dir/scripts/build-web.sh"
grep -q 'CARGO_BUILD_JOBS="$jobs"' "$host_dir/scripts/build-web.sh"
grep -q 'linker command failed due to signal' "$host_dir/scripts/build-web.sh"
grep -q 'browser runtime is missing required WASM export' "$host_dir/scripts/build-web.sh"
grep -q '"$web_stage/axiom_runtime_bg.wasm"' "$host_dir/scripts/build-web.sh"
grep -q 'axiom_runtime_bg.wasm' "$host_dir/web/host.js"
grep -q 'model.hotReload === true' "$host_dir/web/host.js"
grep -q 'prefers-reduced-motion' "$host_dir/web/host.js"
grep -q 'axiom-authored-styles' "$host_dir/web/host.js"
grep -q 'isBenignResizeObserverError' "$host_dir/web/host.js"
grep -q 'element.style.inset = "0"' "$host_dir/web/host.js"
grep -q 'view.style.position = "fixed"' "$host_dir/web/host.js"
grep -q 'backdrop.style.inset = "0"' "$host_dir/web/host.js"
grep -q 'runLoadActionOnce' "$host_dir/web/host.js"
grep -q '!selection.isCollapsed' "$host_dir/web/host.js"
grep -q 'removeProperty("background-image")' "$host_dir/web/host.js"
grep -q 'axiom-scope-${component.name}' "$host_dir/web/host.js"
...
grep -q "implementation 'androidx.viewpager2:viewpager2:1.0.0'" "$host_dir/android/AxiomUIHost/build.gradle"
...
grep -q 'ANIMATOR_DURATION_SCALE' "$host_dir/android/AxiomUIHost/src/main/java/com/axiom/uihost/AxiomHostActivity.java"
...
grep -q 'clearInputFocusForTemplateReplacement' "$host_dir/android/AxiomUIHost/src/main/java/com/axiom/uihost/AxiomHostActivity.java"
grep -q 'hideSoftInputFromWindow' "$host_dir/android/AxiomUIHost/src/main/java/com/axiom/uihost/AxiomHostActivity.java"
